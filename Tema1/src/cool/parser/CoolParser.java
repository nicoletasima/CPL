...
public class CoolParser extends Parser {
	...
	public static class FormalContext extends ParserRuleContext {
		...
		public TerminalNode NAME_ID() { return getToken(CoolParser.NAME_ID, 0); }
	...
	public final FormalContext formal() throws RecognitionException {
		...
		try {
			...
			{
			setState(19);
			((FormalContext)_localctx).name = match(NAME_ID);
			setState(20);
			match(COLON);
			setState(21);
	...
	public final VarDefContext varDef() throws RecognitionException {
		...
		try {
			...
			{
			setState(23);
			((VarDefContext)_localctx).name = match(NAME_ID);
			setState(24);
			match(COLON);
			setState(25);
	...
	public final FeatureContext feature() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(30);
				((FuncDefContext)_localctx).name = match(NAME_ID);
				setState(31);
				match(LPAREN);
				setState(40);
				_errHandler.sync(this);
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << WHILE) | (1L << CASE) | (1L << LET) | (1L << BOOL) | (1L << ISVOID) | (1L << NEW) | (1L << NOT) | (1L << TYPE_ID) | (1L << NAME_ID) | (1L << INTEGER) | (1L << STRING) | (1L << COMPLEMENT) | (1L << LPAREN) | (1L << LBRACE))) != 0)) {
					{
					{
					setState(46);
			...
			case 2:
				...
				{
				setState(54);
				((MemberDefContext)_localctx).name = match(NAME_ID);
				setState(55);
				match(COLON);
				setState(56);
				((MemberDefContext)_localctx).type = match(TYPE_ID);
				setState(59);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==ASSIGN) {
	...
	public final ClassDefContext classDef() throws RecognitionException {
		...
		try {
			...
			if (_la==INHERITS) {
				...
				match(INHERITS);
				setState(67);
				((ClassDefContext)_localctx).parentType = match(TYPE_ID);
				}
			}
	...
	public static class NameIDContext extends ExprContext {
		public TerminalNode NAME_ID() { return getToken(CoolParser.NAME_ID, 0); }
		public NameIDContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CoolParserListener ) ((CoolParserListener)listener).enterNameID(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CoolParserListener ) ((CoolParserListener)listener).exitNameID(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CoolParserVisitor ) return ((CoolParserVisitor<? extends T>)visitor).visitNameID(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeIDContext extends ExprContext {
		public TerminalNode TYPE_ID() { return getToken(CoolParser.TYPE_ID, 0); }
		public TypeIDContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CoolParserListener ) ((CoolParserListener)listener).enterTypeID(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CoolParserListener ) ((CoolParserListener)listener).exitTypeID(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CoolParserVisitor ) return ((CoolParserVisitor<? extends T>)visitor).visitTypeID(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(81);
				((ImplicitDispatchContext)_localctx).name = match(NAME_ID);
				setState(82);
				match(LPAREN);
				setState(91);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << IF) | (1L << WHILE) | (1L << CASE) | (1L << LET) | (1L << BOOL) | (1L << ISVOID) | (1L << NEW) | (1L << NOT) | (1L << TYPE_ID) | (1L << NAME_ID) | (1L << INTEGER) | (1L << STRING) | (1L << COMPLEMENT) | (1L << LPAREN) | (1L << LBRACE))) != 0)) {
					{
					setState(83);
			...
			case 5:
				...
				match(IN);
				setState(128);
				((LetContext)_localctx).body = expr(21);
				}
				break;
			case 6:
				{
			...
			case 7:
				...
				_prevctx = _localctx;
				setState(140);
				((CaseBranchContext)_localctx).name = match(NAME_ID);
				setState(141);
				match(COLON);
				setState(142);
			...
			case 8:
				...
				match(COMPLEMENT);
				setState(148);
				((ComplementContext)_localctx).op = expr(18);
				}
				break;
			case 9:
				{
			...
			case 10:
				{
				_localctx = new NameIDContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(153);
				match(NAME_ID);
			...
			case 17:
				...
				_prevctx = _localctx;
				setState(162);
				((AssignContext)_localctx).name = match(NAME_ID);
				setState(163);
				match(ASSIGN);
				setState(164);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						match(LE);
						setState(183);
						((LessOrEqualContext)_localctx).right = expr(6);
						}
						break;
					case 6:
						{
						...
						match(LT);
						setState(186);
						((LessContext)_localctx).right = expr(5);
						}
						break;
					case 7:
						{
					...
					case 8:
						...
						if (_la==AT) {
							...
							match(AT);
							setState(192);
							((ExplicitDispatchContext)_localctx).type = match(TYPE_ID);
							}
						}
						...
						match(DOT);
						setState(196);
						((ExplicitDispatchContext)_localctx).name = match(NAME_ID);
						setState(197);
						match(LPAREN);
						setState(206);
						_errHandler.sync(this);
	...
	public static final String _serializedATN =
		...
		"\3\7\3\7\3\7\3\7\3\7\3\7\3\7\5\7\u00aa\n\7\3\7\3\7\3\7\3\7\3\7\3\7\3\